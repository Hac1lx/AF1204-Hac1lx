...
@app.cell
def _(cap_filter, chart_esg, chart_scatter, chart_violin, context_box,
       llm_preview, mean_cod, mo, n_obs, persona_box, sector_filter,
       summary, tab_profile, task_box, temp_slider, violin_filter):
    ...
    tab_pipeline = mo.vstack([
        ...
        mo.callout(mo.md(
            "Playwright pipeline scrapes sustainability PDFs and counts keyword occurrences."
        ), kind="warn"),
        chart_esg,
        mo.md("""
**Pipeline stages (Week 7):**
- Script 1: Playwright + User-Agent spoofing, cookie storage
- Script 2: Recursive URL crawling with keyword filter
- Script 3: PDF download, PyMuPDF/pytesseract extraction, download ledger
        """),
        mo.md("---"),
        mo.md("### Part B — LLM Prompt Engineering Playground (Week 8)"),
        mo.callout(mo.md(
            "Build a structured prompt using the Week 8 template. "
            "Change persona, task, context and temperature to see the prompt update live."
        ), kind="info"),
...
- Reactive prompt builder using Week 4 widget patterns - **self-exploration**
        """),
    ])

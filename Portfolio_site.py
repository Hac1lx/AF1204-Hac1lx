...
@app.cell
def _(cap_filter, chart_esg, chart_scatter, chart_violin, mean_cod, mo,
       n_obs, sector_filter, summary, tab_profile, violin_filter):
    ...
    tab_pipeline = mo.vstack([
        mo.md("## Web Scraping Pipeline — ESG Keyword Analysis (Week 7)"),
        mo.callout(mo.md(
            "The Week 7 pipeline uses **Playwright** to bypass bot detection, "
            "recursively crawls corporate websites for sustainability PDFs, "
            "and counts keyword occurrences using **PyMuPDF** or **pytesseract** OCR. "
            "This chart shows what the pipeline output looks like."
        ), kind="warn"),
        chart_esg,
        mo.md("""
...
- Script 3: PDF download, text extraction, keyword ledger df_DL.csv
        """),
    ])
